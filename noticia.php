...
?>
					<br/> <img class="img-gui" src="data:image/jpeg;base64,<?php echo base64_encode($Foto); ?>" />
					<p class="blur">
						<?php echo $Texto; ?>
					</p>
					<hr/>
                ...
                </span> <span><?php echo $Data; ?></span> </span>
							<br/> <span class="icon-text">
                <span class="icon">
                    <i class="far fa-eye"></i>
                </span> <span><?php echo $Visualizacao; ?></span> </span>
						</div>
						<div style="max-width:50%;">
							<p style="margin-bottom:0px;">Compartilhar</p>
							<p class="buttons">
								<button class="button" style="background-color:#8b9dc3"> <span class="icon">
                        <i class="fab fa-facebook"></i>
                    </span> </button>
								<button class="button" style="background-color:#25D366"> <span class="icon is-small">
